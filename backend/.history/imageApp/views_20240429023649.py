...
class UploadImages(APIView):
    def post(self, request: HttpRequest):
        try:
            ...
            #    result_image_file.write(result_pil_image.read())
            print("11")
            #my_model_instance = ImageModel(watch_image=watch_image_decoded,wrist_image=wrist_image_decoded, result_image=result_pil_image)
