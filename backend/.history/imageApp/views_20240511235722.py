    ...
    if request.method == 'POST':
        ...
        try:
            ...
            if 'wristImage' in request.FILES and 'watchImage' in request.FILES:
                ...
                uploaded_image.wrist_image.save('wrist_image.jpg', ContentFile(wrist_image.read()))
                uploaded_image.watch_image.save('watch_image.jpg', ContentFile(watch_image.read()))
                ...
                print("----Saving images")
                uploaded_image.wrist_image.save('wrist_image.jpg', wrist_image)
                uploaded_image.watch_image.save('watch_image.jpg', watch_image)
                uploaded_image.result_image.save('result_image.jpg', result_image)
                print("----Saved images")
