...
class UploadImages(APIView):
    def post(self, request):
        try:
            ...
            """# Save watch image
            print("Here 44")
            my_model_instance.watch_image.save(watch_image_path, request.data('watchImage'))
            my_model_instance.save()

            # Save wrist image
            print("Here 55")
            my_model_instance.wrist_image.save(wrist_image_path, request.data('wristImage'))
            my_model_instance.save() """
            ...
            my_model_instance = ImageModel(watchImage=watch_image_data, wristImage=wrist_image_data, result_image=)
