...
from imageApp.views import ImageUploadView, ResultImageView, hello_world
from rest_framework import routers
from .views import ImageViewSet, UploadImages

router = routers.DefaultRouter()
router.register(r'images', ImageViewSet)
router.register(r'uploadimages', ImageViewSet)
