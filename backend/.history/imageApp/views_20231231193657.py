...
def upload_image(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            grayscale_data = grayscale_image(uploaded_image.image.path, save_path)
            uploaded_image.grayscale_image = f'data:image/jpeg;base64,{base64.b64encode(grayscale_data).decode()}'
            uploaded_image.save()
