...
class UploadImages(APIView):
    def post(self, request: HttpRequest):
        try:
            ...
            wrist_image_name = 'result_image.jpg'
            result_image_content = ContentFile(wrist_image_decoded)
            my_model_instance.wrist_image.save(result_image_io, wrist_image_content, save=True)
