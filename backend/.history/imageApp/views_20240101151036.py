...
def upload_image(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            my_model_instance.image.save(instance1_image)
            my_model_instance.grayscale_image.save(instance2_image)
            
            #my_model_instance.image.save(instance1_image.name, instance1_image)
            #my_model_instance.grayscale_image.save(instance2_image.name, instance2_image)
