...
class UploadImages(APIView):
    def post(self, request):
        try:
            ...
            print(66)
            context = {
                'watch_image_url': my_model_instance.wrist_image_path.url,
                'wrist_image_url': my_model_instance.wrist_image_path.url,
                #'result_image': my_model_instance.result_image.url,
            }
