...
def UploadImages(request):
    ...
    if request.method == 'POST':
        # Check if 'wristImage' and 'watchImage' files are present in the request.FILES
        if 'wristImage' in request.FILES and 'watchImage' in request.FILES:
            ...
            # Process the images as needed (e.g., save to disk, perform operations)
            
            # Return a JSON response with a success message or any relevant data
