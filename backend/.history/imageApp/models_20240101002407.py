...
class ImageModel(models.Model):
    ...
    grayscale_image = models.ImageField(upload_to='your_model_grayscale_images', blank=True)

    def save(self, *args, **kwargs):
        if not self.grayscale_image:
            # Assuming the grayscale images are named based on the original image name
