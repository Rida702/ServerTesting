...
def upload_image(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            my_model_instance.grayscale_image.save(grayscale_image_name, instance2_image)
            my_model_instance.save()

            #my_model_instance.grayscale_image.save(f"grayscale_{instance1_image.name}", instance2_image)
