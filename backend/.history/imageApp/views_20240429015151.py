...
class UploadImages(APIView):
    def post(self, request: HttpRequest):
        try:
            ...
            print("wrist_image_path", wrist_image_path)
            print("watch_image_path", watch_image_path)
            
            base_url = request.build_absolute_uri('/')  # This will include the scheme, domain, and port (if applicable)            # Print the base URL
            ...
            print("-------result_pil_image\n",result_pil_image)
            #watch_image_path = os.path.join('media', 'watch_image.jpg')

            print(5)
            my_model_instance = ImageModel(watch_image=watch_image_data,wrist_image=wrist_image_data)
